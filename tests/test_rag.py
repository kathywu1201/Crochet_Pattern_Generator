...
# def test_load_text_and_image_embeddings(sample_image_embedding):
...
#     try:
#         load_text_and_image_embeddings(df, collection=None)
#     except Exception as e:
#         pytest.fail(f"load_text_and_image_embeddings raised an error: {e}")


### Integration Tests ###
def test_chunk_creation(sample_text_file):
...
# def test_embedding_and_loading(sample_text_file, sample_image_embedding):
...
### System Tests ###
# def test_full_pipeline(setup_folders, sample_text_file, sample_image_embedding):
#     """End-to-end test covering all stages."""
