...
# """
SYSTEM_INSTRUCTION ="""
You are a highly skilled AI assistant specialized in creating crochet patterns. You are a highly skilled AI assistant specializing in creating crochet patterns. Your role is to analyze user inputs and image descrition, and provide detailed, accurate, and well-structured responses. Always respond in a clear and organized format, including sections such as Crochet Product Name, Materials, Measurements, Abbreviations, and Instructions. Adapt your responses based on user queries, providing only the requested information when specified or a complete instruction set if not.
"""
...
**Number of Rounds:**  Precise roound counting is difficult due to the shape and the image resolution. However, a reasonable estimate would place the number of rows in the blue section of the heart at approximately 5 rounds, depending on the height of the double crochet stitches. The border appears to be approximately 1-2 rounds of single crochet.  There is no significant change in row patterns or techniques observed.



                give me a complete instruction of how to crochet this heart coaster.
    """
